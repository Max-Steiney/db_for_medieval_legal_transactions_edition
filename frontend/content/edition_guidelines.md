...
Die Datenbank `db_for_medieval_legal_transactions` ist eine TEI-XML-basierte prosopographische Datenbank mittelalterlicher Wiener Rechtsgeschaefte (ca. 1177--1524). Das Datenmodell folgt dem [Factoid-Ansatz](https://doi.org/10.1093/llc/fqi022) der digitalen Prosopographie und orientiert sich an [TEI P5](https://tei-c.org/release/doc/tei-p5-doc/en/html/).

### Entstehungsgeschichte

- **Masterarbeit:** Immobilientransfers Wien 1360--1373 (Excel-basiert)
...
| Sammlung | Zeitraum |
|----------|----------|
| QGW/Vienna\_1177-1414\_ready | 1177--1414 |
| QGW/Vienna\_1415-1417 | 1415--1417 |
| QGW/Vienna\_1458-66 | 1458--1466 |
| QGW/Vienna\_1493-1500 | 1493--1500 |
| QGW/Vienna\_1524 | 1524 |
| Stadtbuecher/Band\_1\_1395-1400\_ready | 1395--1400 |
...
Aktuelle Bestandszahlen sind auf der [Statistik-Seite](statistics.html) abrufbar; die Schema-Validierung erfolgt gegen `sources/schema/toolbox.rng` (RelaxNG).
...
*Quelle: QGW II/1 Nr. 1 (1198--1230)*
...
Die Struktur der Personen-ID selbst -- normalisierter Vorname + Nachname + Quelle + Nummer -- bildet bereits eine erste Individualisierungsschicht. Unterschiedliche Quellen erzeugen unterschiedliche IDs fuer potentiell identische Personen. Die Zusammenfuehrung erfolgt ueber `@sameAs` im Register; sie ist eine historisch-prosopographische Urteilsfrage und keine algorithmische Operation.
...
Nicht alle Triggerstrings und roleName-Eintraege im Bestand sind durch die Normalisierungslisten abgedeckt; aktuelle Abdeckungsraten sind auf der [Statistik-Seite](statistics.html) einsehbar.
...
> *Wiener Urkundenbuch: Digitale Edition.* Universitaet Wien, 2026. https://chpollin.github.io/db_for_medieval_legal_transactions/
...
@misc{wub_digital,
  ...
  title        = {Wiener Urkundenbuch: Digitale Edition},
  year         = {2026},
