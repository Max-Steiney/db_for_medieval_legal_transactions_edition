# Query-Interface für digitale Urkundensammlung

Wissensdokument als Implementierungsgrundlage für den Analysebereich der Edition mittelalterlicher Wiener Rechtsgeschäfte. Deployment als statisches Frontend auf GitHub Pages, auf Basis der vorhandenen JSON-Datengrundlage.
...
- Kartenvisualisierung über `places_search.json` (717 Orte mit Koordinaten als MVP).
- Netzwerkvisualisierung der Beziehungen aus `epic_b` (5.664 Personen, 12.178 Kanten).
