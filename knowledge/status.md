...
- Frontend-Code: [github.com/Max-Steiney/db\_for\_medieval\_legal\_transactions\_edition](https://github.com/Max-Steiney/db_for_medieval_legal_transactions_edition)
- Datengrundlage: [github.com/KGruenwald/db\_for\_medieval\_legal\_transactions](https://github.com/KGruenwald/db_for_medieval_legal_transactions)
...
- [~] [**Organisations-Register**](\<PAGES\_BASE\>/register/orgs.html)
   * Befund: Filtert die Liste live; geprüft werden Name, ID, Aktivitätszeitraum, Sub-Label der Erstnennung.
- [~] [**Personennetzwerk**](\<PAGES\_BASE\>/exploration/personennetzwerk.html)
...
### [**Quellen**](\<PAGES\_BASE\>/documents.html)
...
- [?] **Erschließungsform-Symbol fehlt bei vielen Quellen.** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [Quellen-Liste mit Filter „ohne Erschließungsform"](\<PAGES\_BASE\>/documents.html?forms=none) zeigt die 176 oeffentlich sichtbaren (27 QGW-Privilegien plus 149 Stadtbuecher; Satzbuch CD nur im internen Build, Released-Scope gesamt 214); [eingeengt auf QGW](\<PAGES\_BASE\>/documents.html?forms=none&collection=QGW/Vienna_1177-1414_ready) zeigt die 27 Privilegien-Quellen; [QGW Nr. 15 als Stichprobe](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/15.html).
...
- [x] **Filter „Erschließungsform" für Nicht-Fachleute schwer einordnenbar.** (Herkunft: Stakeholder-Review 11.05.2026; entschieden Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Quellen-Liste, Sidebar-Block „Erschließungsform"](\<PAGES\_BASE\>/documents.html).
...
- [~] **Belegt-Kategorie präzisieren** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [Burg Kufstein](\<PAGES\_BASE\>/register/orgs/org__kufstein-burg.html) (eine Quelle, „Datum der Quelle 1397"), [Zwettl Zisterzienser](\<PAGES\_BASE\>/register/orgs/org__zwettl-zisterzienser.html) (zwei Quellen mit Lücke, „Datum der Quellen 1342 bis 1388"), [Wien St. Stephan](\<PAGES\_BASE\>/register/orgs/org__wien-st_stephan.html) (viele Quellen, breite Spanne), [Organisations-Register-Sidebar](\<PAGES\_BASE\>/register/orgs.html), [Personen-Register-Sidebar](\<PAGES\_BASE\>/register/persons.html).
...
- [?] **Relationale Tags sichtbar machen, wenn Organisationen innerhalb anderer Tags annotiert sind.** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [Burg Kufstein, Quellen-Block](\<PAGES\_BASE\>/register/orgs/org__kufstein-burg.html) zeigt Quelle 222 (StB I), [Stadtbuch-Eintrag 223a](\<PAGES\_BASE\>/documents/Stadtbuecher/Band_1_1395-1400_ready/223a.html) zeigt Burg Kufstein nicht in der Annotationen-Tabelle, obwohl `#org__kufstein-burg` als `corresp` auf der `<roleName type="occ">phleger</roleName>` von Rudolf von Rosenhaim sitzt.
...
- [x] **Person-IDs in der öffentlichen Ansicht ausblenden.** (Herkunft: Stakeholder-Review 11.05.2026, bestätigt Protokoll 18.05.2026 A.3.2)
   ...
   * Verifikation: [Org-Profil Burg Kufstein](\<PAGES\_BASE\>/register/orgs/org__kufstein-burg.html), [Personen-Profil Adelheid](\<PAGES\_BASE\>/register/persons/pe__adelheid_QGW_II_I_1111.html), [Stadtbuch-Eintrag 223a](\<PAGES\_BASE\>/documents/Stadtbuecher/Band_1_1395-1400_ready/223a.html). Im privaten Build und mit `?dev=1` weiterhin sichtbar.
...
#### [Auswertungen](\<PAGES\_BASE\>/analysis/auswertungen.html)
...
#### [Abfragen](\<PAGES\_BASE\>/analysis/index.html)
...
- [~] **Gib mir alle Personen, die in der Verwandtschaft Personen aus der Uhlirz-Handwerkerkategorie IV haben und miteinander verheiratet sind.** (Herkunft: Stakeholder-Anfrage)
   * Verifikation: [Abfrage-Interface, Uhlirz IV](\<PAGES\_BASE\>/analysis/index.html#p1=u=IV%20Erzeugung%20und%20Vertrieb%20von%20Leuchtstoffen%20Fetten%20und%20Oelen)
...
- [~] **Gib mir alle Personen, die als Berufsbezeichnung eine Uhlirz-Kategorie VI aufweisen, und zeige deren Hausbesitzorte auf einer Karte an.** (Herkunft: Stakeholder-Anfrage)
   * Verifikation: [Abfrage-Interface, Uhlirz VI](\<PAGES\_BASE\>/analysis/index.html#p1=u=VI%20Lederindustrie)
...
- [~] **Gib mir alle Personen, die mit St. Stephan über die Kategorie occ (Tätigkeit) verbunden sind, sowie deren Verwandte.** (Herkunft: Stakeholder-Anfrage)
   * Verifikation 1: [Abfrage-Interface, naive Annäherung über Ko-Vorkommen](\<PAGES\_BASE\>/analysis/index.html#g1=n=St.%20Stephan%20\(Pfarr-%20und%20Domkirche\))
   ...
   * Verifikation 2: [Org-Profil St. Stephan, Block „Personen mit Tätigkeitsverbindung"](\<PAGES\_BASE\>/register/orgs/org__wien-st_stephan.html)
...
- [x] **Gib mir alle Personen/Organisationen, die durch ein Issuer-Recipient-Verhältnis mit St. Agnes auf der Himmelpforte verbunden sind.** (Herkunft: Stakeholder-Anfrage)
   * Verifikation 1: [Abfrage-Interface, Person Issuer plus Agnes Recipient](\<PAGES\_BASE\>/analysis/index.html#p1=r=issuer&g1=r=recipient,n=St.%20Agnes%20\(auf%20der%20Himmelpforte\)%20Wien). Angezeigt sind Events, in denen eine beliebige Person als Ausstellerin und St. Agnes als Empfängerin auftritt.
   * Verifikation 2: [Abfrage-Interface, Gegenrichtung Agnes Issuer plus Person Recipient](\<PAGES\_BASE\>/analysis/index.html#g1=r=issuer,n=St.%20Agnes%20\(auf%20der%20Himmelpforte\)%20Wien&p1=r=recipient). Angezeigt sind Events, in denen St. Agnes ausstellt und eine Person empfängt.
   * Verifikation 3: [Abfrage-Interface, Org-Org-Konstellation mit Agnes als Recipient](\<PAGES\_BASE\>/analysis/index.html#g1=r=issuer&g2=r=recipient,n=St.%20Agnes%20\(auf%20der%20Himmelpforte\)%20Wien). Angezeigt sind Events, in denen eine andere Organisation ausstellt und St. Agnes empfängt.
...
- [~] **Projekt** (Herkunft: eigene Beobachtung, Stakeholder-Protokoll A.6)
   * Bearbeiten: [https://github.com/Max-Steiney/db\_for\_medieval\_legal\_transactions\_edition/edit/main/frontend/content/project/about.md](https://github.com/Max-Steiney/db_for_medieval_legal_transactions_edition/edit/main/frontend/content/project/about.md)
...
- [ ] **Annotationsrichtlinien** (Herkunft: eigene Beobachtung)
   * Bearbeiten (kanonische Quelle, Schwester-Repo): [https://github.com/KGruenwald/db\_for\_medieval\_legal\_transactions/edit/main/edition\_guidelines.md](https://github.com/KGruenwald/db_for_medieval_legal_transactions/edit/main/edition_guidelines.md)
...
- [~] **Glossar** (Herkunft: eigene Beobachtung, Stakeholder-Protokoll A.6)
   * Bearbeiten: [https://github.com/Max-Steiney/db\_for\_medieval\_legal\_transactions\_edition/edit/main/frontend/content/project/glossar.md](https://github.com/Max-Steiney/db_for_medieval_legal_transactions_edition/edit/main/frontend/content/project/glossar.md)
...
- [ ] **Impressum** (Herkunft: eigene Beobachtung)
   * Bearbeiten: [https://github.com/Max-Steiney/db\_for\_medieval\_legal\_transactions\_edition/edit/main/frontend/content/impressum.md](https://github.com/Max-Steiney/db_for_medieval_legal_transactions_edition/edit/main/frontend/content/impressum.md)
...
- [x] **Verlinkung Person | Organisation → Urkunden** (Herkunft: eigene Beobachtung)
   * Befund: Jede Profil-Seite (Personen und Orgs) trägt eine Quellen-Tabelle mit Signatur, Datum, Korpus, Bezeichnung, Rolle und Regest-Anriss. Verifikation: [Burg Kufstein](\<PAGES\_BASE\>/register/orgs/org__kufstein-burg.html).
...
- [ ] **Quellenansicht** (Herkunft: eigene Beobachtung)
   * Beispiel: [\<PAGES\_BASE\>/documents/QGW/Vienna\_1177-1414\_ready/105.html](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/105.html)
- [ ] **Person** (Herkunft: eigene Beobachtung)
   * Beispiel: [\<PAGES\_BASE\>/register/persons/pe\_\_adelheid\_QGW\_II\_I\_1111.html](\<PAGES\_BASE\>/register/persons/pe__adelheid_QGW_II_I_1111.html)
- [ ] **Organisation** (Herkunft: eigene Beobachtung)
   * Beispiel: [\<PAGES\_BASE\>/register/orgs/org\_\_klosterneuburg-augustiner\_chorherren.html](\<PAGES\_BASE\>/register/orgs/org__klosterneuburg-augustiner_chorherren.html)
...
- [x] **Zoom-Funktion der Digitalisate ist nicht navigierbar, vergrößerte Ausschnitte lassen sich nicht verschieben.** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [QGW Vienna Nr. 100](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/100.html)
- [x] **„Datenherkunft" ist unklar formuliert („Wiener Stadt- und Landesarchiv 9 Pers., 0 Org.").** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [QGW Vienna Nr. 1022](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1022.html)
...
- [x] **Dispositivformeln werden nicht klar voneinander getrennt dargestellt.** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [QGW Vienna Nr. 1022](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1022.html), fünf benachbarte Dispositivformeln im Regest sind jetzt einzeln erkennbar.
- [~] **Mehrere Kategorien innerhalb der Annotationstabellen erscheinen unklar oder nicht notwendig. Tabellen auf wissenschaftlich nachvollziehbare und öffentlich verständliche Kategorien reduzieren.** (Herkunft: Stakeholder-Review 11.05.2026)
   ...
   * Verifikation: [QGW Vienna Nr. 1022](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1022.html) (Mehrfach-Disp-Worst-Case mit Datenfehler-Spur bei Stephans witib), [QGW Vienna Nr. 23](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/23.html) (Einfach-Event-Fall), [QGW Vienna Nr. 320](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/320.html) (Multi-Event mit gefülltem Editorische-Ergänzungen-Tab), [Stadtbuch I Nr. 223a](\<PAGES\_BASE\>/documents/Stadtbuecher/Band_1_1395-1400_ready/223a.html) (Stadtbuch-Format), [QGW Nr. 1022 mit `?dev=1`](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1022.html?dev=1) (private Sicht mit Dispositivformeln-Tab eingeblendet).
...
- [x] **Mechanik öffentliche vs. interne Sicht (dev-only)** (Herkunft: Editions-Workflow)
   ...
   * Verifikation: Beliebige Quellen-Detailseite mit und ohne `?dev=1` vergleichen, z. B. [QGW Vienna Nr. 23 öffentlich](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/23.html) versus [QGW Vienna Nr. 23 intern](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/23.html?dev=1).
...
- [~] **Datenkorb-Erklärung ergänzen** (Herkunft: Stakeholder-Protokoll 18.05.2026 A.1.2: „Datenkorb als gute Idee aber Erklärung und Testung notwendig.")
   ...
   * Verifikation: [Datenkorb-Seite](\<PAGES\_BASE\>/korb.html). Hover über Korb-Button in der Topbar zeigt die Aufschlüsselung.
...
- [x] **Glossar-Links in der Korpora-Übersicht auf der Startseite funktionieren nicht.** (Herkunft: Stakeholder-Protokoll 18.05.2026 A.1.1)
   ...
   * Verifikation: [Startseite](\<PAGES\_BASE\>/), Klick auf „im Glossar"-Link in den Korpus-Spalten der Korpora-Übersicht öffnet die Glossar-Seite mit dem richtigen Anker.
...
- [~] **Disp-Vorschau im Annotations-Section-Header als Quellenzitat visuell markieren.** (Herkunft: Eigene Beobachtung, Diskussion 23.05.2026)
   ...
   * Verifikation: [QGW Nr. 1245](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1245.html) (Vidimierungs-Fall mit Auslassungspunkten), [QGW Nr. 1022](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1022.html), [Stadtbuch 223a](\<PAGES\_BASE\>/documents/Stadtbuecher/Band_1_1395-1400_ready/223a.html) (Fallback-Fall, nur Counter).
...
- [x] **Belege-Zähler im Org-Profil-Block „Personen mit Tätigkeitsverbindung" zeigte 0 statt der tatsächlichen Anzahl.** (Herkunft: eigene Beobachtung 23.05.2026)
   ...
   * Verifikation: [Burg Kufstein, Block „Personen mit Tätigkeitsverbindung"](\<PAGES\_BASE\>/register/orgs/org__kufstein-burg.html) zeigt jetzt Belege 1 für Rudolf von Rosenheim mit Verlinkung auf [Stadtbuch I Nr. 223a](\<PAGES\_BASE\>/documents/Stadtbuecher/Band_1_1395-1400_ready/223a.html).
...
- [x] **Kategorie „Tod" in „als verstorben genannt" umbenennen.** (Herkunft: Stakeholder-Review)
   * Verifikation: [pe\_\_christian\_von\_strass\_StB\_I\_624](\<PAGES\_BASE\>/register/persons/pe__christian_von_strass_StB_I_624.html)
...
- [x] **A1 Ausstellungsort aus der Volltextsuche entfernen.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Quellen-Liste](\<PAGES\_BASE\>/documents.html).
...
- [x] **A4 Filter „Geschlechter-Mix" umbenennen, Option „ohne Personen" entfernen.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Quellen-Liste, Sidebar](\<PAGES\_BASE\>/documents.html).
- [x] **A5 Zeitraum-Histogramm zeigt zwei Tooltips gleichzeitig.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Quellen-Liste](\<PAGES\_BASE\>/documents.html), Zeitraum-Histogramm.
...
- [x] **B2 Faksimile sitzt bei langem Regest zu weit unten.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [QGW Nr. 105](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/105.html) (langes Regest), [QGW Nr. 2](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/2.html) (kurzes Regest).
- [x] **B1 Vollbildansicht für den Viewer.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [QGW Nr. 2](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/2.html).
- [x] **B3 doc 105: „ihr" mit aufgelöstem Namen aus der Verknüpfung.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [QGW Nr. 105, Annotationen](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/105.html), Zeile „ihr".
...
- [~] **C1 Rollen-Labels gendergerecht und konsistent über Profile, Sidebar, Tooltips.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Personen-Register-Sidebar](\<PAGES\_BASE\>/register/persons.html) (Plural-Chips), [QGW Nr. 1022 Annotationstabelle](\<PAGES\_BASE\>/documents/QGW/Vienna_1177-1414_ready/1022.html) (Singular pro Person).
...
- [x] **E1 Topbar-Badge entitätsweise aufschlüsseln, globaler Leeren-Button.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Datenkorb-Seite](\<PAGES\_BASE\>/korb.html). Eintrag auf einer Quellenseite hinzufügen, dann Nav-Badge und Korb-Header prüfen.
...
- [x] **H1 Typ-Filter zeigt Rohcodes statt Labels.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Organisations-Register](\<PAGES\_BASE\>/register/orgs.html).
- [x] **H2 OTHER ans Ende, als „Sonstige" anzeigen.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Org-Register, Filter OTHER](\<PAGES\_BASE\>/register/orgs.html?types=OTHER).
...
- [x] **H3 Klassen-Label „Kloster (Frauenorden)" / „Kloster (Männerorden)" einheitlich.** (Herkunft: Stakeholder-Durchgang 02.06.2026)
   ...
   * Verifikation: [Org-Register, Typ-Filter](\<PAGES\_BASE\>/register/orgs.html).
