...
Menschen-Events sind ein Sonderfall des Datenmodells (Definition in Menschen-Event). Personen-Annotationen in verschachtelten Events werden nicht doppelt gezählt, siehe [[specification#Nennungen zählen nur Personen-Annotationen außerhalb mentioned Events]]. Kartenvisualisierungen und Netzwerk-Visualisierungen liegen konzeptionell im Bereich [[exploration]].
